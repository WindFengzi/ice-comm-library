 ...
 * @created 2014-9-01
 */
public class WinsoBaseAppManager {

	private static Stack<Activity> activityStack;
	private static WinsoBaseAppManager instance;

	public WinsoBaseAppManager() {
	}

	/**
	 * 单一实例
	 */
	public static WinsoBaseAppManager getAppManager() {
		if (instance == null) {
			instance = new WinsoBaseAppManager();
		}
		return instance;
	}
