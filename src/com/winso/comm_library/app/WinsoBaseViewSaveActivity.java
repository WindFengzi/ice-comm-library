 ...
 * @created 2014-12-11
 */
public abstract class WinsoBaseViewSaveActivity extends WinsoBaseActivity {
	...
	public class MyCallBack_download implements CallbackInterface {
		...
		MyCallBack_download(WinsoBaseViewSaveActivity ac) {
			mAc = ac;
		}
	}
	 ...
	 * 下载文件
	 */
	abstract public boolean downloadFile(String sRemote, String sLocal) ;
}
