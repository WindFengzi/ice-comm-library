...
public abstract class AMI_MQInterface_execProc extends Callback_MQInterface_execProc
{
    public abstract void ice_response(boolean __ret, String set, String error);
    ...
    public final void response(boolean __ret, String set, String error)
    {
