...
public abstract class AMI_MQInterface_selectPrepareByParam extends Callback_MQInterface_selectPrepareByParam
{
    public abstract void ice_response(boolean __ret, String sID, String error);
    ...
    public final void response(boolean __ret, String sID, String error)
    {
        ice_response(__ret, sID, error);
    }
