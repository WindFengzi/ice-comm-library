...
final class _AMD_MQInterface_select extends IceInternal.IncomingAsync implements AMD_MQInterface_select
{
    public _AMD_MQInterface_select(IceInternal.Incoming in)
    {
        super(in);
    }
