...
public abstract class AMI_MQInterface_selectNext extends Callback_MQInterface_selectNext
{
    public abstract void ice_response(int __ret, String set);
    ...
    public final void response(int __ret, String set)
    {
        ice_response(__ret, set);
    }
