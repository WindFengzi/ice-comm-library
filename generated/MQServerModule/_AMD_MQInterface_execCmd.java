...
final class _AMD_MQInterface_execCmd extends IceInternal.IncomingAsync implements AMD_MQInterface_execCmd
{
    public _AMD_MQInterface_execCmd(IceInternal.Incoming in)
    {
        super(in);
    }
